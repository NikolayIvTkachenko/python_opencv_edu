...
for i in range(1, 4):
    tk.Radiobutton(root, text=f"{i}D", variable=dim_var, value=i, command=update_slices).grid(row=0, column=i,
                                                                                              sticky="w")
...
tk.Scale(root, from_=1, to=20, orient="horizontal", variable=size_1, command=start_visualization).grid(row=1, column=1,
                                                                                                       columnspan=3,
                                                                                                       sticky="w")

tk.Label(root, text="Размер по оси Y:").grid(row=2, column=0, sticky="w")
tk.Scale(root, from_=1, to=20, orient="horizontal", variable=size_2, command=start_visualization).grid(row=2, column=1,
                                                                                                       columnspan=3,
                                                                                                       sticky="w")

tk.Label(root, text="Размер по оси Z:").grid(row=3, column=0, sticky="w")
tk.Scale(root, from_=1, to=20, orient="horizontal", variable=size_3, command=start_visualization).grid(row=3, column=1,
                                                                                                       columnspan=3,
                                                                                                       sticky="w")
...
tk.Scale(slice_1_frame, from_=0, to=20, orient="horizontal", variable=slice_1_start, command=start_visualization).grid(
    row=0, column=1, sticky="w")
tk.Label(slice_1_frame, text="Конец:").grid(row=0, column=2, sticky="w")
tk.Scale(slice_1_frame, from_=0, to=20, orient="horizontal", variable=slice_1_end, command=start_visualization).grid(
    row=0, column=3, sticky="w")
tk.Label(slice_1_frame, text="Шаг:").grid(row=1, column=0, sticky="w")
tk.Scale(slice_1_frame, from_=1, to=10, orient="horizontal", variable=slice_1_step, command=start_visualization).grid(
...
tk.Scale(slice_2_frame, from_=0, to=20, orient="horizontal", variable=slice_2_start, command=start_visualization).grid(
    row=0, column=1, sticky="w")
tk.Label(slice_2_frame, text="Конец:").grid(row=0, column=2, sticky="w")
tk.Scale(slice_2_frame, from_=0, to=20, orient="horizontal", variable=slice_2_end, command=start_visualization).grid(
    row=0, column=3, sticky="w")
tk.Label(slice_2_frame, text="Шаг:").grid(row=1, column=0, sticky="w")
tk.Scale(slice_2_frame, from_=1, to=10, orient="horizontal", variable=slice_2_step, command=start_visualization).grid(
    row=1, column=1, sticky="w")
...
tk.Scale(slice_3_frame, from_=0, to=20, orient="horizontal", variable=slice_3_start, command=start_visualization).grid(
    row=0, column=1, sticky="w")
tk.Label(slice_3_frame, text="Конец:").grid(row=0, column=2, sticky="w")
tk.Scale(slice_3_frame, from_=0, to=20, orient="horizontal", variable=slice_3_end, command=start_visualization).grid(
    row=0, column=3, sticky="w")
tk.Label(slice_3_frame, text="Шаг:").grid(row=1, column=0, sticky="w")
tk.Scale(slice_3_frame, from_=1, to=10, orient="horizontal", variable=slice_3_step, command=start_visualization).grid(
    row=1, column=1, sticky="w")
